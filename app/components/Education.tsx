  ...
  const educationData = [
    {
      ...
      description:
        "My second degree was focused on learning about chemical engineeing and related concepts such as material balance, reactors, rate of chemical reactions and plant design.I took courses in computer programmming of a chemical reaction, the use of Matlab in design, the use of HYSYS to design a chemical plant and refining of chemical products. Graduated with honors.",
    },
    {
